  ...
  describe('GET /server/about', () => {
    it('should return about information', async () => {
      ...
      expect(body).toEqual({
        ...
        improvedVersion: '1.0.0',
        repository: 'rshaker2-ops/improved-immich',
        repositoryUrl: 'https://github.com/rshaker2-ops/improved-immich',
        build: '1234567890',
        buildUrl: 'https://github.com/rshaker2-ops/improved-immich/actions/runs/1234567890',
        buildImage: 'e2e',
        buildImageUrl: 'https://github.com/rshaker2-ops/improved-immich/pkgs/container/immich-server',
        sourceRef: 'e2e',
        sourceCommit: 'e2eeeeeeeeeeeeeeeeee',
        sourceUrl: 'https://github.com/rshaker2-ops/improved-immich/commit/e2eeeeeeeeeeeeeeeeee',
