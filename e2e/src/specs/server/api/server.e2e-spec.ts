  ...
  describe('GET /server/about', () => {
    it('should return about information', async () => {
      ...
      expect(body).toEqual({
        ...
        improvedVersion: '1.3.0',
        repository: 'rshaker2-ops/hearth',
        repositoryUrl: 'https://github.com/rshaker2-ops/hearth',
        build: '1234567890',
        buildUrl: 'https://github.com/rshaker2-ops/hearth/actions/runs/1234567890',
        buildImage: 'e2e',
        buildImageUrl: 'https://github.com/rshaker2-ops/hearth/pkgs/container/hearth-server',
        sourceRef: 'e2e',
        sourceCommit: 'e2eeeeeeeeeeeeeeeeee',
        sourceUrl: 'https://github.com/rshaker2-ops/hearth/commit/e2eeeeeeeeeeeeeeeeee',
