...
class BackgroundWorkerApiImpl: BackgroundWorkerFgHostApi {
  ...
  private static let refreshTaskID = "com.lordblight.hearth.background.refreshUpload"
  private static let processingTaskID = "com.lordblight.hearth.background.processingUpload"
